...
<div class="container-fluid">
    <div class="container">
      <table class="table table-hover">
        ...
        <tbody>
          <?php
            $query = $source->Query("SELECT * FROM event where approval='Approved'");
            ...
            if($row->approval==='Approved'){
              ...
              $approval_text="class = text-success text-uppercase";
                ...
                <td>"."<a href='pendingsql.php?pending=".$row->id."' class='btn btn-outline-warning text-warning mt-2'> Pending</a>".$app." </td>
                </tr>";
